...
<head>
    ...
    <!--here for pusher notify-->
    <script src="https://js.pusher.com/8.2.0/pusher.min.js"></script>
    <script>
        // Enable pusher logging - don't include this in production
  Pusher.logToConsole = true;

  var pusher = new Pusher('1fb8aff1c97f78424953', {
    cluster: 'ap1'
  });

  var channel = pusher.subscribe('send_notify_skincare');
...
//   window.Echo.channel('send_notify_skincare')
//     .listen('.my-notify', (e) => {
//         alert(e);
//     });
    </script>
